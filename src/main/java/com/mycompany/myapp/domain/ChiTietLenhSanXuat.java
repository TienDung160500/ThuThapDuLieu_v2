...
public class ChiTietLenhSanXuat implements Serializable {
    ...
    public ChiTietLenhSanXuat reelID(Integer reelID) {
    ...
    public ChiTietLenhSanXuat userData4(Integer userData4) {
    ...
    public ChiTietLenhSanXuat userData5(Integer userData5) {
    ...
    public ChiTietLenhSanXuat warmupTime(ZonedDateTime warmupTime) {
    ...
    public ChiTietLenhSanXuat sapCode(Integer sapCode) {
