...
class ChiTietLenhSanXuatResourceIT {
    ...
    private static final Integer DEFAULT_REEL_ID = 1;
    private static final Integer UPDATED_REEL_ID = 2;
    ...
    private static final Integer DEFAULT_USER_DATA_4 = 1;
    private static final Integer UPDATED_USER_DATA_4 = 2;

    private static final Integer DEFAULT_USER_DATA_5 = 1;
    private static final Integer UPDATED_USER_DATA_5 = 2;
    ...
    private static final ZonedDateTime DEFAULT_WARMUP_TIME = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_WARMUP_TIME = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    private static final Integer DEFAULT_SAP_CODE = 1;
    private static final Integer UPDATED_SAP_CODE = 2;
    ...
    void getAllChiTietLenhSanXuats() throws Exception {
        ...
        restChiTietLenhSanXuatMockMvc
            ...
            .andExpect(jsonPath("$.[*].warmupTime").value(hasItem(sameInstant(DEFAULT_WARMUP_TIME))))
    ...
    void getChiTietLenhSanXuat() throws Exception {
        ...
        restChiTietLenhSanXuatMockMvc
            ...
            .andExpect(jsonPath("$.warmupTime").value(sameInstant(DEFAULT_WARMUP_TIME)))
