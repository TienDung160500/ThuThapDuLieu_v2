...
describe('SanXuatHangNgay e2e test', () => {
  ...
  describe('new SanXuatHangNgay page', () => {
    ...
    it('should create an instance of SanXuatHangNgay', () => {
      ...
      cy.get(`[data-cy="ngayTao"]`).type('2023-10-09T22:03').should('have.value', '2023-10-09T22:03');

      cy.get(`[data-cy="timeUpdate"]`).type('2023-10-09T18:42').should('have.value', '2023-10-09T18:42');
