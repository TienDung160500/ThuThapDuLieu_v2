...
describe('ThietBi e2e test', () => {
  ...
  describe('new ThietBi page', () => {
    ...
    it('should create an instance of ThietBi', () => {
      ...
      cy.get(`[data-cy="ngayTao"]`).type('2023-10-09T06:21').should('have.value', '2023-10-09T06:21');

      cy.get(`[data-cy="timeUpdate"]`).type('2023-10-09T12:27').should('have.value', '2023-10-09T12:27');
