...
describe('LenhSanXuat e2e test', () => {
  ...
  const lenhSanXuatSample = { maLenhSanXuat: 42797 };
  ...
  describe('new LenhSanXuat page', () => {
    ...
    it('should create an instance of LenhSanXuat', () => {
      ...
      cy.get(`[data-cy="entryTime"]`).type('SCSI Burg redundant').should('have.value', 'SCSI Burg redundant');

      cy.get(`[data-cy="status"]`).type('Soft Borders').should('have.value', 'Soft Borders');

      cy.get(`[data-cy="comment"]`).type('salmon').should('have.value', 'salmon');
