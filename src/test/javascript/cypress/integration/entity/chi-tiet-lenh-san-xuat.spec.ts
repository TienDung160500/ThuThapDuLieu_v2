...
describe('ChiTietLenhSanXuat e2e test', () => {
  ...
  const chiTietLenhSanXuatSample = {
    reelID: 69924,
    partNumber: 'online digital hack',
    vendor: 'Villages',
    lot: 'Tunnel Yen incentivize',
    userData1: 'action-items Missouri lavender',
    userData2: 'e-commerce Cotton',
    userData3: 'out-of-the-box (Bouvetoya) content',
    userData4: 95337,
    userData5: 80090,
    initialQuantity: 69961,
    quantityOverride: 72349,
    storageUnit: 'plug-and-play Account',
    expirationDate: 'Shoals Plastic',
    manufacturingDate: 'Convertible Facilitator ADP',
  };
  ...
  describe('new ChiTietLenhSanXuat page', () => {
    ...
    it('should create an instance of ChiTietLenhSanXuat', () => {
      ...
      cy.get(`[data-cy="warmupTime"]`).type('2023-10-09T06:22').should('have.value', '2023-10-09T06:22');
