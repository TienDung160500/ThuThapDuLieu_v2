...
describe('KichBan e2e test', () => {
  ...
  describe('new KichBan page', () => {
    ...
    it('should create an instance of KichBan', () => {
      ...
      cy.get(`[data-cy="ngayTao"]`).type('2023-10-09T20:51').should('have.value', '2023-10-09T20:51');

      cy.get(`[data-cy="timeUpdate"]`).type('2023-10-09T12:25').should('have.value', '2023-10-09T12:25');
