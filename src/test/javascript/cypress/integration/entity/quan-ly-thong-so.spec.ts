...
describe('QuanLyThongSo e2e test', () => {
  ...
  describe('new QuanLyThongSo page', () => {
    ...
    it('should create an instance of QuanLyThongSo', () => {
      ...
      cy.get(`[data-cy="ngayTao"]`).type('2023-10-09T20:15').should('have.value', '2023-10-09T20:15');

      cy.get(`[data-cy="ngayUpdate"]`).type('2023-10-09T08:08').should('have.value', '2023-10-09T08:08');
